...
func _on_sheep_pressed() -> void:
	##_update_sheep_xp_display()
	print("click!")
	get_node("Creature Buttons/CreaturesList").gain_xp(0)
...
##	_update_goblin_xp_display()
	print("click!")
	get_node("Creature Buttons/CreaturesList").gain_xp(1)
	print(str(get_node("Creature Buttons/CreaturesList/Goblin").xp))
...
func _on_hydra_pressed() -> void:
	##_update_hydra_xp_display()
	print("click!")
	get_node("Creature Buttons/CreaturesList").gain_xp(2)
...
func _on_slime_pressed() -> void:
	##_update_slime_xp_display()
	print("click!")
	get_node("Creature Buttons/CreaturesList").gain_xp(3)
